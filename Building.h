...
private:
	...
	osg::ref_ptr<osg::Geode> osg_assemble(OGRMultiPolygon*,osg::PrimitiveSet::Mode,bool doTesselate,osg::Vec4);	
	osg::ref_ptr<osg::Geode> osg_assemble(std::vector<Footprint>&,osg::Vec4 color = WHITE);
	
	int num_vertices(OGRMultiPolygon*);
